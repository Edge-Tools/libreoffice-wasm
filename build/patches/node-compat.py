...
# 1. runUnoScriptUrls: skip importScripts when unavailable or empty.
old1 = (
...
# 2. LOWA-channel sender: include port in postMessage data.
...
# 3. setupMainChannel receiver: fall back to e.data.port for Node.js workers.
